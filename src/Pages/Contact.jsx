...
import CommentSection from "../components/Commentar";
  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] ">
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Have a question or want to connect? Send me a message and I’ll get
          back to you soon.
          <br />
          <span className="block mt-2 text-base text-[#a855f7] font-semibold">
            Email:{" "}
            <a href="mailto:tesfamichael132@gmail.com" className="underline">
              tesfamichael132@gmail.com
            </a>
          </span>
        </p>
      </div>
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  Want to discuss a project, collaboration, or just say hi? Send
